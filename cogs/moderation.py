...
class Moderation(commands.Cog):
    ...
    async def kick(self, ctx, member : discord.Member, *, reason=None):
        ...
        kick = discord.Embed(title="👢 Member Kicked!", description="I have kicked the member from this server!", color=0xFF0000)
    ...
    async def ban(self, ctx, member : discord.Member, *, reason=None):
        ...
        ban = discord.Embed(title="<a:JD_banned:818014712297029643> Member Banned!", description="I have banned the member from this server!", color=0xFF0000)
